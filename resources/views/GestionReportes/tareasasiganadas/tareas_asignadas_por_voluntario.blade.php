...
@section('title', 'Tareas por Voluntario')

@section('content_header')
    <h1>Tareas asignadas a Voluntarios</h1>
@stop
    ...
    @foreach($voluntarios as $voluntario)
        <div class="card my-3">
            <div class="card-header">
                <strong>{{ $voluntario->personal->nombre ?? 'Sin nombre' }}</strong>
            </div>
            <div class="card-body">
                @forelse($voluntario->tareas as $tarea)
